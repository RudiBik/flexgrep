...
public:
    ...
    //!
    //! \param[in] pattern  throws on empty pattern and patterns containing multiple *
	//!----------------------------------------------- 
...
private:
	...
	bool subMatch(StringIterator sp, StringIterator ep, StringIterator st, StringIterator et) const;
	bool subMatchStar(StringIterator sp, StringIterator ep, StringIterator st, StringIterator et) const;
