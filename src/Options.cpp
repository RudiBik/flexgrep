...
Options::Options(const std::string &rootPath, const std::string &filenameWildcard, const std::string &regexContent, bool bskipBinaries, bool bParallelContentFiltering) {
